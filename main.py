...
perfect_miss_font = pygame.font.SysFont(None, 50) #(글자체, 글자크기)
main_font = pygame.font.SysFont(None, 150) #(글자체, 글자크기)
info_font = pygame.font.SysFont(None, 70)
...
def runGame():
    ...
    while not done: 
        ...
        mySound = pygame.mixer.Sound( "background.mp3" )
        ...
        while not done:
            ...
            if perfect_text >= 0:
                ...
                myText = perfect_miss_font.render("Perfect", True, (255 - dc, 255 - dc, 255 - dc))
                screen.blit(myText, (mc.x - 50, mc.y - 50))
                perfect_text -= 1
                
            if miss_text >= 0:
                dc = 255 - int(miss_text * 12.75)
                myText = perfect_miss_font.render("Miss", True, (255 - dc, 0, 0))
            ...
            if miss_count >= hp:
                myText = main_font.render("Game over", True, (255, 0, 255))
                screen.blit(myText, (700, 400))
                
            if is_cleared:
                myText = main_font.render("Game Clear", True, (0, 255, 0))
                screen.blit(myText, (700, 400))
                
            myText = info_font.render("Stage " + str(stage), True, (255, 255, 255))
            screen.blit(myText, (0, 0))
                
            myText = info_font.render("HP : " + str(hp - miss_count), True, (255, 255, 255))
